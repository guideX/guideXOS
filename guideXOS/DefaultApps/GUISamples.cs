...
namespace guideXOS.DefaultApps {
    ...
    internal class GUISamples : Window {
        ...
        public GUISamples(int x, int y) : base(x, y, 540, 420) {
            Title = "GUI Samples";
            ShowInTaskbar = true;
            ShowMinimize = true;
            ShowMaximize = false;
        ...
        public override void OnDraw() {
            base.OnDraw();
            int pad = 12;
            WindowManager.font.DrawString(X + pad, Y + pad, "GUI Control Samples:");
            WindowManager.font.DrawString(X + pad, Y + pad + 24, "Buttons, Lists, Dropdowns & callbacks.");
        }
    }
}