    ...
    internal class FConsole : Window {
        ...
        private static char MapFromKey(System.ConsoleKeyInfo key) {
            ...
            if (k >= System.ConsoleKey.A && k <= System.ConsoleKey.Z) {
                bool upper = Keyboard.KeyInfo.Modifiers.HasFlag(System.ConsoleModifiers.Shift) ^ Keyboard.KeyInfo.Modifiers.HasFlag(System.ConsoleModifiers.CapsLock);
            ...
            switch (k) {
                case System.ConsoleKey.OemPeriod: return '.';
                case System.ConsoleKey.OemComma: return ',';
                case System.ConsoleKey.OemMinus: return '-';
                case System.ConsoleKey.OemPlus: return '+';
                case System.ConsoleKey.Oem1: return ';';
                case System.ConsoleKey.Oem2: return '/';
                case System.ConsoleKey.Oem3: return '`';
                case System.ConsoleKey.Oem4: return '[';
                case System.ConsoleKey.Oem5: return '\\';
                case System.ConsoleKey.Oem6: return ']';
                case System.ConsoleKey.Oem7: return '\'';
            }
            return '\0';
        }
        ...
        public void DrawString(int X, int Y, string Str, int HeightLimit = -1, int LineLimit = -1) {
            ...
            for (int i = 0; i < Str.Length; i++) {
                ...
                if ((LineLimit != -1 && w + WindowManager.font.FontSize > LineLimit) || Str[i] == '\n') {
                    w = 0; h += WindowManager.font.FontSize;
